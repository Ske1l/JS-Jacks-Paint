function configureListeners() {
    let images = document.getElementsByTagName('img')// select img elements // i initially tried query selector all, didn't work
...
function addOpacity(event) {
    ...
    } // add appropriate CSS class  //i wasn't really sure what to do here
...
function getProductInfo(paintColor) {
    ...
    function updatePrice(colorName, price) {
        ...
        let color = document.getElementById('color-name');
        colorPrice.textContent = colorName // select element with corresponding id
        //display color name
    }
